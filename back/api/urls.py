...
from .views.views_fbv import product_detail, product_list, canvas_list, canvas_detail, \
    review_list,delete_order
from .views.views import product_canvas, product_review,OrderListGet,OrderListCreate,OrderListUpdate,OrderListDelete
...
urlpatterns = [
    ...
    path('canvas/', canvas_list),
    path('canvas/<int:canvas_id>/', canvas_detail),
    path('product/<int:product_id>/canvas/', product_canvas),
